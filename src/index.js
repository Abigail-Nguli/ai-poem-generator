...
function getPoem(event){
    ...
    let context = `Generate a poem in html format(Do not write the word html) with each line separated by <br/>, the poem should NOT have a title and the poem should not be more than 5 lines. The last line should be signed with <strong>AI Poem</strong>`;
